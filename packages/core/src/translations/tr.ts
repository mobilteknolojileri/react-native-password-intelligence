...
const warnings: PasswordIntelligenceTranslations['warnings'] = {
...
export const trTranslations: PasswordIntelligenceTranslations = {
  warnings,
  suggestions: {
  ...
  // Keyed by the dictionary names registered in `core/engine.ts`.
  // `turkish_firstnames` is absent on purpose: zxcvbn explains it itself.
  dictionaryWarnings: {
    turkish_surnames: warnings.namesByThemselves,
    turkish_teams:
      'Futbol takımı adları ve taraftar terimleri kolay tahmin edilir.',
    turkish_cities: 'Şehir adları kolay tahmin edilir.',
    turkish_plate_patterns: 'Şehir plaka kodları kolay tahmin edilir.',
    turkish_cultural: 'Kültürel ve tarihî terimler kolay tahmin edilir.',
    turkish_keyboard: warnings.straightRow,
    turkish_romantic: 'Sevgi sözcükleri parolalarda çok sık kullanılır.',
    turkish_religious: 'Dinî ve ideolojik terimler kolay tahmin edilir.',
    turkish_common: "Bu, Türkiye'de yaygın kullanılan bir paroladır.",
    turkish_zodiac: 'Burç adları kolay tahmin edilir.',
    turkish_brands: 'Marka adları kolay tahmin edilir.',
    custom: 'Bu parola, kuruma özgü yasaklı kelime listesinde yer alıyor.',
  },
};
